        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-2 justify-items-center cursor-pointer">
          {randomItems.map((randomItem) => (
            <div
              ...
              key={randomItem.id}
              onClick={() => dispatch(selectedProduct(randomItem))}
            >
              <Link
                href="/Products"
              ...
              >
                <img
                  ...
                  alt={randomItem.group}
                  className="w-20 h-20 rounded-full flex items-center justify-center mx-auto"
                />
                <div className="mt-0 pb-2">
                  <h6 className="font-medium text-xs text-center pt-1">
                    {randomItem.name}
                  </h6>
                  <h6 className="font-semibold text-xs text-center">
                    ${randomItem.price}
                  </h6>
                </div>
              </Link>
