...
const CategorySection = () => {
    // handling the searching of the items that matches what I wanted 
    const searchItem=useAppSelector((state)=>state.cart.searchItem)||"";
    const filteredCategories=categories.filter((category)=>category.group.toLowerCase().includes(searchItem.toLowerCase())
);
