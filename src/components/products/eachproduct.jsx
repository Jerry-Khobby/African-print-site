...
const EachProduct = () => {
    ...
    return(
    <div className='w-full  flex  flex-row items-center justify-center mt-24 gap-32 flex-wrap'>
...
<div>
    <div>
        <h2>{nextItem.name}</h2>
        <h2>This Cloth belongs to the {nextItem.group} group </h2>
        <h4>${nextItem.price}</h4>
        <h5>{nextItem.description}</h5>
    </div>
